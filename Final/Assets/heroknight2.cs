...
public class heroknight2 : MonoBehaviour
{ 
...
void Update()
{
    ...
    //}
            ...
            // Block
    if (Input.GetKeyDown("u") && !m_rolling)
    {
...
void AE_SlideDust()
{
    ...
    void Attack()
    {
        ...
        //{
            ...
            {
                enemy.GetComponent<HeroKnight>().TakeDamage(attackDamage);
                enemy.GetComponent<HeroKnight>().chealth(attackDamage);
    ...
    public void chealth(int damage)
    {
        if (block == false)
        {
            ...
            if (currentH == 180)
            {
                var block = GameObject.FindWithTag("12");
                Destroy(block);
            }
            if (currentH == 160)
            {
                var block = GameObject.FindWithTag("22");
                Destroy(block);
            }
            if (currentH == 140)
            {
                var block = GameObject.FindWithTag("32");
                Destroy(block);
            }
            if (currentH == 120)
            {
                var block = GameObject.FindWithTag("42");
                Destroy(block);
            }
            if (currentH == 100)
            {
                var block = GameObject.FindWithTag("52");
                Destroy(block);
            }
            if (currentH == 80)
            {
                var block = GameObject.FindWithTag("62");
                Destroy(block);
            }
            if (currentH == 60)
            {
                var block = GameObject.FindWithTag("72");
                Destroy(block);
            }
            if (currentH == 40)
            {
                var block = GameObject.FindWithTag("82");
                Destroy(block);
            }
            if (currentH == 20)
            {
                var block = GameObject.FindWithTag("92");
                Destroy(block);
            }
            if (currentH == 0)
            {
                var block = GameObject.FindWithTag("102");
                Destroy(block);
            }
        }
    }
